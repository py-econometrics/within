...
const PRECOND_BYTES: &[u8] = include_bytes!("fixtures/preconditioner_v15.postcard");
const PRE_BUMP_BYTES: &[u8] = include_bytes!("fixtures/preconditioner_v14.postcard");
...
/// `crates/within/tests/fixtures/preconditioner_v15.postcard`. Intended for
...
fn regenerate_wire_format_fixture() {
    ...
    path.push("tests/fixtures/preconditioner_v15.postcard");
