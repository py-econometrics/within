...
const PRECOND_BYTES: &[u8] = include_bytes!("fixtures/preconditioner.postcard");
...
/// `crates/within/tests/fixtures/preconditioner.postcard`. Intended for
...
fn regenerate_wire_format_fixture() {
    ...
    path.push("tests/fixtures/preconditioner.postcard");
