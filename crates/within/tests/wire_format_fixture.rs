...
const WIRE_FORMAT_VERSION: u32 = 11;
const PRECOND_BYTES: &[u8] = include_bytes!("fixtures/preconditioner_v11.postcard");
const PRE_BUMP_BYTES: &[u8] = include_bytes!("fixtures/preconditioner_v10.postcard");
...
/// `crates/within/tests/fixtures/preconditioner_v11.postcard`. Intended for
...
fn regenerate_wire_format_fixture() {
    ...
    path.push("tests/fixtures/preconditioner_v11.postcard");
