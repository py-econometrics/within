...
the configuration used to construct it as `.config` and its original build time in
seconds as `.build_time_seconds`; both are preserved across pickling and reuse.
